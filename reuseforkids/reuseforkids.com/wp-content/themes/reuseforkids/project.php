...
#byPC ul #bot_1 {
	background-image: url(images/pro_b01.jpg);
	text-indent: -9999px;
}
#byPC ul #bot_1 a:hover {
	background-image: url(images/pro_b01.jpg);
	text-indent: -9999px;
	background-position: right 0%;
}
#byPC ul #bot_2  {
	background-image: url(images/pro_b02.jpg);
	text-indent: -9999px;
	padding-left: 0px;
}
#byPC ul #bot_2 a:hover  {
	background-image: url(images/pro_b02.jpg);
	text-indent: -9999px;
	background-position: right 0%;
}
...
<!-- InstanceBeginEditable name="コンテンツ領域" -->
  <div class="con_t">
  	<h1>プロジェクト概要</h1>
  	<p>『リユースforきっず』は、不要になったPCや、読まなくなった本を寄付(リユース)することで、こどもたちへ教育プログラムを贈ることができるプロジェクトです。</p>
  </div>
  <div id="byPC">
    <div class="suv_t">
      <h2>リユースforきっず by PC</h2>
      <h3><img src="<?php  bloginfo('template_url');  ?>/images/by_pc2.jpg" alt="" width="875" height="245" id="byPC_image"></h3>
      <p>企業で不要になったＰＣを回収し、こどもたちにタブレットと楽しい時間をプレゼント！<br>『モノを大切にする気持ち』や『タブレットを安全に正しく使う』『ICTを使ったコミュニケーション』を楽しく学べる教育プログラムを提供します。その結果をＣＳＲレポートにまとめてお渡しします。</p>
      <h5><img src="<?php  bloginfo('template_url');  ?>/images/RFK_byPC_illust.jpg" alt="" width="730" height="180" id="byPC_illust1"></h5>
      <ul>
        <li id="bot_1"><a href="<?php  html2wp_the_page_link( 'corporation.php' );  ?>">リユースで社会貢献する</a></li>
        <li id="bot_2"><a href="<?php  html2wp_the_page_link( 'program.php' );  ?>">こどもたちに教育プログラムを贈る</a></li>
        </ul>
    </div>
      <h4><img src="<?php  bloginfo('template_url');  ?>/images/POINT_PC.jpg" alt="" width="820" height="490" id="byPC_point"></h4>
      <h5><img src="<?php  bloginfo('template_url');  ?>/images/RFK_byPC_illust2.jpg" alt="" width="395" height="195" id="byPC_illust2"></h5>
  </div>
<div> 
<div id="byBOOK">
<div class="suv_t">
  <h2>リユースforきっず by BOOK</h2>
  <p>「PCで数を出すのは大変だけど、本ならできるかも？」個人のいらない本でも学童保育に通うこどもたちを支援することができます！企業・学校・団体単位でのご協力ももちろん歓迎です！ＰＣと本、併せての寄付も歓迎！！</p>
</div>
  <h5><img src="<?php  bloginfo('template_url');  ?>/images/RFK_byBOOK_illust.jpg" alt="" width="595" height="175" id="byBOOK_illust"></h5>
 <ul>
 <li id="bot_3"><a href="<?php  html2wp_the_page_link( 'general.php' );  ?>">リユースで社会貢献する</a></li>
 <li id="bot_4"><a href="<?php  html2wp_the_page_link( 'program.php' );  ?>">こどもたちに教育プログラムを贈る</a></li>
 </ul>
  <h4><img src="<?php  bloginfo('template_url');  ?>/images/POINT_BOOK.jpg" alt="" width="820" height="470" id="byBOOK_point"></h4>
  <h6>※寄付される本が段ボール１０箱以上など大量の場合はお電話でご連絡の際ご相談ください。<br>※買取できなかった本は、福祉施設・フリースクールへの寄贈または、古紙リサイクル業者にお引き渡しさせていただきます。</h6>
</div>  
</div>
<h3 id="contact"><a href="<?php  html2wp_the_page_link( 'contact.php' );  ?>">お申し込み・お問い合わせ</a></h3>
<!-- InstanceEndEditable -->
</div>
<div id="footer">
  <div id="message">
