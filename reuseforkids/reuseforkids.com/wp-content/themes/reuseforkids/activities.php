<?php
			/*
				Template Name: html2wp-activities
			*/
...
<!-- InstanceBeginEditable name="コンテンツ領域" -->
  <div class="con_t">
  <h1>活動実績</h1>
  <p>これまでに『リユース for きっず』に寄付頂いたことで、こどもたちへ実施できた教育プログラムの報告です。</p>
  </div>
  <div class="suv_t">
  <h2>宝印刷×三川公園サニースクール</h2>
  <h3><a href="<?php  bloginfo('template_url');  ?>/20160302CSR_report.pdf" target="_blank"><img src="<?php  bloginfo('template_url');  ?>/images/act_report.jpg" alt="" width="480" height="377" id="takara"></a></h3>
